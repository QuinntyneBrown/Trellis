...
/**
 * Renders the outcome of the most recent diagram render. The data-render-seq
 * counter increments exactly once per completed render outcome (success or
 * failure) so E2E tests can assert "did the preview actually update" without
 * diffing SVG markup.
 */
@Component({
